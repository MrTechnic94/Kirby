...
module.exports = {
    ...
    async execute(_client, message) {
        ...
        if (queue.filters.ffmpeg.getFiltersEnabled().length >= clientPlayerOptions.maxFiltersEnabled && queue.filters.ffmpeg.isDisabled('bassboost_low')) return message.channel.send({ embeds: [errorEmbeds.max_filters_enabled_error] });
